...
public extension UIColor {
    /// Brand red color
    static var brandRed: UIColor = .init(hex: "#D73C4B")
    /// Label color
    static var label: UIColor = .dynamicColor(
        light: .black,
        dark: .white
    )
    /// Disabled label color (excluded acessories)
    static var disabledLabel: UIColor = .dynamicColor(
        light: .gray(level: 2),
        dark: .gray(level: 5)
    )
    ...
    static var buttonBackground: UIColor = .brandRed
    /// Primary background color (package view)
    static var primaryBackground: UIColor = .dynamicColor(
        light: .white,
        dark: .black
    )

    /// Secondary background color (view controller)
    static var secondaryBackground: UIColor = .dynamicColor(
        light: .gray(level: 1),
        dark: .gray(level: 6)
    )
    ...
    static func thumbnailBorder(selected: Bool) -> UIColor {
        switch selected {
