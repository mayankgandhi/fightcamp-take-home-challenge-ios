...
class PackageImagesView: UIView {
    ...
    private func setupViews() {
        ...
        NSLayoutConstraint.activate([
            vStackView.topAnchor.constraint(equalTo: topAnchor, constant: CGFloat.packageSpacing),
            vStackView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: CGFloat.packageSpacing),
            thumbnailImage.heightAnchor.constraint(equalToConstant: .thumbnailHeight),
            thumbnailImage.widthAnchor.constraint(equalTo: widthAnchor, constant: -2 * CGFloat.packageSpacing),
        ])
    }
